...
function demoState() {
  ...
  return {
    ...
    teachers: [
      { id: 'T01', name: 'Asha', maxPerWeek: 25, subjects: [{ code: 'MAT', maxPerWeek: 20 }] },
      { id: 'T02', name: 'Bala', maxPerWeek: 25, subjects: [{ code: 'PHY', maxPerWeek: 20 }] },
      { id: 'T03', name: 'Chitra', maxPerWeek: 25, subjects: [{ code: 'CHE', maxPerWeek: 20 }] },
      { id: 'T04', name: 'Dev', maxPerWeek: 25, subjects: [{ code: 'ENG', maxPerWeek: 20 }] },
      {
        id: 'T05', name: 'Ezhil', maxPerWeek: 25,
        subjects: [{ code: 'TAM', maxPerWeek: 12 }, { code: 'CS', maxPerWeek: 6 }],
      },
      { id: 'T06', name: 'Fatima', maxPerWeek: 10, subjects: [{ code: 'ART', maxPerWeek: 6 }] },
    ],
    classes: [
      { id: 'C1', name: 'Grade 9 A', assignments: [...base(), { teacherId: 'T05', code: 'CS', periodsPerWeek: 2 }] },
      { id: 'C2', name: 'Grade 9 B', assignments: [...base(), { teacherId: 'T05', code: 'CS', periodsPerWeek: 2 }] },
      { id: 'C3', name: 'Grade 10 A', assignments: [...base(), { teacherId: 'T06', code: 'ART', periodsPerWeek: 2 }] },
      { id: 'C4', name: 'Grade 10 B', assignments: [...base(), { teacherId: 'T06', code: 'ART', periodsPerWeek: 2 }] },
    ],
    manual: { cells: {} },
    lastAuto: null,
  };
